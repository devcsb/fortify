    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <button class="btn btn-danger" id="delete_all" data-url="{{ route('admin.deleteSelected') }}">삭제</button>
        ...
        function row_delete(id) {
            ...
            if (check == true) {
                $.ajax({
                    ...
                    //onclick통항 함수 호출 시에는 반드시 이렇게 해야되는 듯 하나, $function(e) 안에서 선택자 통한 이벤트 감지 방식에서는 곧바로 method 타입
                    //에 DELETE를 적어도 작동한다.
