...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('답글 작성 ') }}</div>
                    <form action="{{ route('qnas.store_reply', ['qna'=>$qna->id]) }}" method="post" name="writeForm"
                          enctype="multipart/form-data">
                        @csrf
                        <table id="write" class="min-w-full divide-y divide-gray-200">
                            <tr>
                                <td class="td_left"><label for="author">작성자</label></td>
                                <td class="td_right"><input name="author" type="text" id="author" value="{{auth()->user()->name}}" readonly>
                                </td>
                            </tr>
                            <tr>
