...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('회원가입 폼') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="radio" id="gender" name="gender" value="male"  @error('gender') is-invalid @enderror>남&nbsp;&nbsp;
                                <input type="radio" id="gender" name="gender" value="female"  @error('gender') is-invalid @enderror>여
