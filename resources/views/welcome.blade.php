    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">내 정보</a>
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">회원가입</a>
                    @endif
                @endauth
            </div>
        @endif
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="col-md-6 offset-md-4">
                <a href="{{ route('qnas.index') }}" class="btn btn-xs btn-info pull-right">qna 목록</a>
            </div>
            <br>
            <div class="col-md-6 offset-md-4">
